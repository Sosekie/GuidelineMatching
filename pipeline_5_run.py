from pipeline.pipeline_5 import run_pipeline_5
...
def main():
    ...
    run_pipeline_5(file_path_excel, file_paths_csv, embedding_cache_path, result_path, gpt_model_name=model_name)
